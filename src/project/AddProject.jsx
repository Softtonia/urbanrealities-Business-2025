...
function AddProject() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData2.name) {
      newErrors.name_error = "**Please add project name**";
    }
    ...
    try {
      ...
      const response = await post(
        `/api/add-project-listing`, formData,);
  ...
  useEffect(() => {
    let fetchPurposeId = async () => {
      await post(
        ...
        { model_fields: formData2.model_fields, post_type: "project_list" }
      )
        .then((response) => {
      ...
      <div className=" add-property-listing-search-wraper">
        <div className=" add-property-form-wraper">
          <div className="add-property-form-h-wraper">
            <h1 className="m-0">Add Project Listing</h1>
          </div>
          {
            // form start here
          }
          <form className="add-form-listing-wraper" onSubmit={handleSubmit}>
            <div className="row">
              ...
              {formData2.property_id ?
                <div className="col-lg-4 col-md-4 col-sm-12 add-listing-form-col">
                  ...
                  <div className="custom-select">
                    ...
                    >
                      ...
                      {Array.isArray(projectName) && projectName.map((record, i) => (
                        <option key={i} value={record.id}>
                          {record.name}
                        </option>
                      ))}
                ...
                </div> : <div className="col-lg-4 col-md-4 col-sm-12 add-listing-form-col"></div>}
              ...
              <div className="col-lg-12 col-md-12 col-sm-12 add-listing-form-col">
                <div className="custom-select">
                  ...
                  <textarea
                    ...
                    onChange={handleChange2}
                    placeholder="Enter Project Street Address"
                  />
                </div>
              </div>
              ...
              {sortedCustomFields?.map((record, i) =>
                record.field_type === "text" ? (
                  ...
                  <div
                    ...
                    key={i}
                  >
                    <label className="">{record.field_label}
                      {record.required === "yes" && <span style={{ color: "var(--orange)" }}>*</span>}
                    </label>
                    <select
                  ...
                  <div
                    ...
                    key={i}
                  >
                    <label className="mb-2">{record.field_label}
                      {record.required === "yes" && <span style={{ color: "var(--orange)" }}>*</span>}
                    </label>
                    {record.options.map((option, index) => (
                  ...
                  <div
                    ...
                    className="col-lg-6 col-md-6 col-sm-12 add-listing-form-col"
                  >
                    <label className="mb-3">{record.field_label}
                      {record.required === "yes" && <span style={{ color: "var(--orange)" }}>*</span>}
                    </label>
                  ...
                  >
                    <label className="mb-3">{record.field_label}
                      {record.required === "yes" && <span style={{ color: "var(--orange)" }}>*</span>}</label>
                    <MediaUpload
                      key={i}
                      record={record}
                                ...
                                {Array.isArray(group) &&
                                  group.map((item, index) => (
                                    <div key={index} className="custom-select mb-3">
                                      <label className="text-capitalize">{item.field_label}
                                        {item.required === "yes" && <span style={{ color: "var(--orange)" }}>*</span>}</label>
