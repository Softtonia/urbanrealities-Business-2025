           ...
           data.map((record,index)=>(
             ...
             <div className='all-consultancy-card-wraper'>
               <div className='all-consultancy-card-profile'>
                 ...
                 <img className='w-100 h-100' src={API_KEY + "/" + record.company.profile_photo}/>
                 </div>
                 <div className='all-consultancy-card-developer'>
                   <p><span>Name &nbsp;:&nbsp;</span>{record.company?.fullname}</p>
                   {

                    <p> <span>Business name :</span>{record.company?.business_name}</p>

                   }
                   <p> <span>Company id &nbsp;:&nbsp;</span> {record.company?.unique_id}</p>
                 {
               ...
               <ul className='all-consultancy-card-list-group'>
                <li>
                 ...
                 <span className='all-consultancy-card-value'>{record.company?.email}</span>
                </li>
                <li>
                 <span className='all-consultancy-card-tittle'>Phone &nbsp;:</span>
                 <span className='all-consultancy-card-value'>{record.company?.phone}</span>
                </li>
               ...
               <button onClick={()=>handleReject(record.company.id,i)} className='reject-request-button bg-danger'>
                  ...
                  :
                  <button onClick={()=>handleLeave(record.company?.id)} className='reject-request-button bg-danger'>
                  <span>Leave</span>
               </button>
                 }
                </div>
