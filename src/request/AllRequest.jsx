  ...
  console.log(message)
    ...
    useEffect(() => {
        ...
        get('/api/get-all-join-request-listing')
          .then(response => {
            console.log(response.data.join_requests); // Check the structure of the data
            setData(response.data.join_requests);
            setLoad(true)
          })
          .catch(err => {
            console.log(err);
